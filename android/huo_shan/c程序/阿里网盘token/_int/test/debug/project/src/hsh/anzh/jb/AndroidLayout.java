...
public class AndroidLayout {
    ...
    protected static final int rg_n4646 = twothree.ceshi.R.id.rg_n4646;
    private rg_n4544 m_linearLayout;
    ...
    private AndroidLayout initAndAddIntoViewGroup (android.content.Context context, final AndroidViewGroup container,
        ...
        if (viewLayout == null)
            return null;
        viewLayout.setTag (rg_n4646, this);
        m_linearLayout = rg_n4544.sNewInstanceAndAttachView (context, viewLayout);
        if (blListenWindowAttachState) {
            viewLayout.addOnAttachStateChangeListener (new View.OnAttachStateChangeListener () {
                @Override public void onViewAttachedToWindow (View v) { rg_n4610 (true); }
                @Override public void onViewDetachedFromWindow (View v) { rg_n4610 (false); }
            } ) ;
        }
        if (container != null) {
            ...
            rg_n4606 (null, objUserData1, objUserData2);
        }
        return this;
    }
    private void AddCreatedView (AndroidViewGroup container, int nIndex, Object objUserData1, Object objUserData2, boolean blRemoveAllFirst) {
        ...
        rg_n4606 (container, objUserData1, objUserData2);
    }
    public static AndroidLayout sSafeGetLayoutObject (View view) {
        if (view != null) {
            Object obj = view.getTag (rg_n4646);
    ...
    public void rg_n4606 (AndroidViewGroup rg_n4607, java.lang.Object rg_n4608, java.lang.Object rg_n4609) {
    }

    public void rg_n4610 (boolean rg_n4611) {
    }
}
